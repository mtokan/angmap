...
builder.Configuration.GetSection("FeaturesDatabase"));
...
{
    option.SwaggerDoc("v1", new OpenApiInfo { Title = "angMap", Version = "v1" });

    option.OperationFilter<BasicAuthOperationsFilter>();
